...
/*
 * Watch (BrowserSync version):
 * build stuff when source files are modified,
...
/*
 * Watch (Livereload version): build stuff when source files are
 * modified, inform livereload when anything in the `build` or
 * `dist` folders change
